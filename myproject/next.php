...
<link rel="stylesheet"type="text/css"href="nxt.css">
...
<table bgcolor="red">
<p> Select Where do you want to pick up your ID?</P>
...
<br/>
<br/>
<button type="submit" style="background:#83C205 "><a href="waiting.html">submit</a></button>
<button type="submit" style="background:#83C205 "><a href="profile form.html">Back</a></button>
</form>
</body>