  <html>
	  ...
	  <body>
	 <form action="mesconnect.php"method="POST">
  ...
  <input type="text" id="number" name="nam" value="" placeholder="write your names here" required><br><br/>
 <lable for="dob">location:</labl>
	<link rel="stylesheet"type="text/css"href="by.css">
	<center>
	<div class="perfect">
<label>Nationality:</label><br>
	       ...
	       <label>cells:</label><br>
			<select name="slct4" id="slct4" onchange="populate3(this.id,'slct5')">
                 </select>
			<br/>
							<br/>
 ...
 <label for="name">phone no:</label><br>
	...
	<input type="number" id="fname" name="no" value="" required><br>
	<br/>
	<label for="name"> email address:</label><br/>
  <input type="email" id="email" name="email" value=""  required><br><br/>
	<label for="lname">message:</label><br/>
  <input type="text2" id="text" name="mesg" value="" placeholder="write your idea/comments about this platform here" required><br><br/>
